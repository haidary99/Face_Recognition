...
def save_attendance_to_excel(df_attendance):
    ...
    if os.path.exists(excel_file):
        ...
        updated_df = df_attendance.merge(existing_df, on="Name", how="left", suffixes=('', '_new'))
...
attendance_dict = {name: {"status": "absent", "arrival_date": "", "arrival_time": "", "departure_date": "", "departure_time": "", "time_difference": ""} for name in names} # Initialize attendance dictionary which has all the names in the db as keys and another dictionary as value
